...
The final **excel** files uses abbreviations to describe the following result types
...
`COMPILER-ERROR` is not listed because then the submission is not executed for any
sample at all.
